...
<body>
    ...
    <nav class="flex w-full flex-wrap items-center justify-between py-2 text-neutral-500 hover:text-neutral-700 focus:text-neutral-700 lg:py-5 sticky top-0 z-50"
        ...
        <div class="flex w-full flex-wrap items-center justify-between px-3">
            ...
            <div class="!visible mt-2 hidden flex-grow basis-[100%] items-center lg:mt-0 lg:!flex lg:basis-auto"
                ...
                <div class="flex items-center">
                    @if(session('id_user'))
                        <a href="{{ route('logout') }}" type="button" data-te-ripple-init data-te-ripple-color="light"
                    ...
                    @elseif(!session('id_user') && !Request::is('login') && !Request::is('member/daftar'))
